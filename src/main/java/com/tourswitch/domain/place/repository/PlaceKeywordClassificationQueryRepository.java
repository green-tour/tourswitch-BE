 ...
 */
@Repository
public class PlaceKeywordClassificationQueryRepository {
    ...
    @SuppressWarnings("unchecked")
    public List<String> findClassificationLevel2CodesByKeywordName(String keywordName) {
        return entityManager.createNativeQuery("""
                SELECT kc.classification_level2_code
                FROM keyword_classification kc
                JOIN keyword k ON k.id = kc.keyword_id
